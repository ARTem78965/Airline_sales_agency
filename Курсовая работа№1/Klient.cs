...
namespace Курсовая_работа_1
{
    public partial class Klient : Form
    {
        ...
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "client_b.Bilet_S". При необходимости она может быть перемещена или удалена.
            this.bilet_STableAdapter.Fill(this.client_b.Bilet_S);
            // TODO: данная строка кода позволяет загрузить данные в таблицу "client_r.Reis_S". При необходимости она может быть перемещена или удалена.
            this.reis_STableAdapter.Fill(this.client_r.Reis_S);
        ...
        {
            if (textBox1.Text == "" || textBox2.Text == "" || textBox3.Text == "" || textBox4.Text == "" || dateTimePicker1.Text == "" || textBox6.Text == "" || textBox7.Text == "" || textBox8.Text == "")
            {
            ...
            {
                select = new SqlCommand($"SELECT date_otp, Otkuda, Do_kuda FROM [Reis] where date_otp = '{dateTimePicker1.Text}' and Otkuda =  '{textBox6.Text}' and Do_kuda =  '{textBox7.Text}' ;", connect);
